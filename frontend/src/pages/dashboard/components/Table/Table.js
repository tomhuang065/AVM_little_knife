...
export default function Topthree(props) {
  ...
  var { _id, title,theme, post_time,poster, post_content, picture, hashtag, like, dislike, commentcount, agreecomments, disagreecomments} = props;
  ...
  return (
    <Card md={4} sm={12} xs={12} elevation={5}>
    <CardActionArea  onClick={()=> {routeChange()}} style={{backgroundColor: '#fafeff',height:'200px',display:'flex',alignItems:'flex-start'}}>
      ...
      <div style={{width:'30%', height: '100%',margin:'10px',textAlign:'right'}}>
          <img src={picture} style={{maxWidth: '100%', maxHeight:'95%', borderRadius:'8%' }}></img>
        </div>
    </CardActionArea>
    <Typography variant="body2" color="text.secondary" style={{display:'flow-root'}}>
      ...
      <div variant="body2" color="text.secondary" style={{float:'left',marginLeft:'10px',marginTop:'20px'}}>
        <Typography >
